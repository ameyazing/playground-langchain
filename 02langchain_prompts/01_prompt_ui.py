...
# Create the prompt
prompt_dict = {}
with open(".\\02langchain_prompts\\hp_character_summary_prompt.json", "r", encoding="utf-8") as f:
    prompt_dict = json.load(f)
prompt_template = PromptTemplate(template=prompt_dict["template"], input_variables=["character", "length", "style"])
prompt = prompt_template.invoke({"character": character_input, "length": length_input, "style": style_input})
